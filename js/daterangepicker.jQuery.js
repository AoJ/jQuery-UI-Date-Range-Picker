...
jQuery.fn.daterangepicker = function(settings){
	...
	var datepickerOptions = {
		onSelect: function(dateText, inst) {
				...
				var raw = {
					...
					to: rp.find('.range-end').datetimepicker('getDate')
				};

				var rangeA = fDate( raw.from );
				var rangeB = fDate( raw.to );
	...
	jQuery.fn.saveDateToData = function(){
		if(!jQuery(this).data('saveDate')){
			jQuery(this).data('saveDate', jQuery(this).datetimepicker('getDate') );
		}
		return this;
	}
